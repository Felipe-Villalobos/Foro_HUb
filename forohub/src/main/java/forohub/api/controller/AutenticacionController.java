...
import forohub.api.domain.usuario.UsuarioDTO;
import forohub.api.infra.security.JWTTokenDTO;
...
public class AutenticacionController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity usuarioAutenticacion(@Valid @RequestBody  UsuarioDTO usuarioDTO) {

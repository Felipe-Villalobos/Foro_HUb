...
import forohub.api.domain.respuesta.*;
...
public class RespuestaController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity respuestaRegistrada (@RequestBody @Valid RespuestaDTO respuestaDTO) throws VerificadorDeIntegridad {
